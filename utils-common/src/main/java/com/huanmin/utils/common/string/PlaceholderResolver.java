package com.huanmin.utils.common.string;



import com.huanmin.utils.common.obj.reflect.FieldUtil;
...
public class PlaceholderResolver {
    ...
    public String resolveByObject(String content, final Object obj) {
        ...
        return resolveByRule(content, placeholderValue -> String.valueOf(FieldUtil.getValueByFieldPath(obj, placeholderValue)));
    }
}