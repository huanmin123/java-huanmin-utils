...
public class BinarySearchUtil {
    ...
    public static <T extends Comparable <T>> int binarySearchFirst(T[] arr, T value) {
        int low = 0;
        int high = arr.length - 1;
        if(value.compareTo(arr[low]) <0  || value.compareTo(arr[high]) >0 ){
            return  -1;
        }
        while(low <= high) {
    ...
    public static <T extends Comparable <T>> int binarySearchLast(T[] arr, T value) {
        int low = 0;
        int high = arr.length - 1;
        if(value.compareTo(arr[low]) <0  || value.compareTo(arr[high]) >0 ){
            return -1;
    ...
    public static   <T extends Comparable <T>>  List<Integer>  binarySearchFirstAndLast(T[] arr, T value) {
        int low = 0;
        int high = arr.length - 1;
    ...
    //(查询全部的值)
    public static <T extends Comparable <T>>  List<Integer> binarySearchAll(T[] arr, T value) {
        int low = 0;
        int high = arr.length - 1;
        ...
        while (low <= high) {
            ...
            if (value.compareTo(arr[mid]) > 0 ) {
                ...
                int temp=mid-1;
                //向左查询
                while (temp >= 0 && arr[temp].compareTo(value)==0) {
                    list.add(temp);
                    temp--;
                }
                //加入序列
                ...
                temp=mid+1;
                //向右查询
                while (temp <= arr.length - 1 && arr[temp].compareTo(value)==0 ) {
                    list.add(temp);
                    temp++;
                }
                return list;
