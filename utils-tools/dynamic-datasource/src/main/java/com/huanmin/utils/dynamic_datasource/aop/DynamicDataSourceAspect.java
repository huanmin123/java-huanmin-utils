package com.huanmin.utils.dynamic_datasource.aop;
...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("@annotation(com.huanmin.utils.dynamic_datasource.aop.DBSwitch)|| @within(com.huanmin.utils.dynamic_datasource.aop.DBSwitch)")
